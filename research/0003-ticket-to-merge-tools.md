...
- Pro (20x): $200/mo (20x Plus limits, includes unlimited Sora, Operator)
...
| **Warp Factories** | Partial | Partial (computer-use verify) | No (review agent evaluates code; human response undocumented) | Slack, Linear, Jira, GitHub | No | Split-plane (Enterprise VPC) | Closed beta ($10K credit) |
...
| **Cosine (Lumen)** | Partial | Partial (runs checks) | No (human review required; auto-iteration undocumented) | Web, IDE | No | Yes (air-gapped) | $20/seat/mo |
...
| **OpenAI Codex Cloud** | Partial | Partial (sandbox only, no post-PR CI) | Yes (responds to tags) | ChatGPT, GitHub bot, CLI, IDE | CLI only (Apache 2.0) | No | $20/mo (Plus); $100/mo (Pro 5x) / $200/mo (Pro 20x) |
